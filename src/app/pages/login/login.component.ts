...
@Component({
    ...
    <div class="auth-page">
      <div class="auth-card">
        <div class="auth-header">
          <h1>SQL Catalog</h1>
          <p>Faça login para acessar seus scripts</p>
        </div>
  ...
  styles: [`
    ...
    .error-msg {
      ...
      padding: 0.6rem 0.9rem; border-radius: 8px; font-size: 0.8rem; font-weight: 500;
    }
    .btn-primary {
